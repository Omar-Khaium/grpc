...
const Todo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'isCompleted', '3': 3, '4': 1, '5': 8, '10': 'isCompleted'},
  ],
};

/// Descriptor for `Todo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List todoDescriptor = $convert.base64Decode('CgRUb2RvEg4KAmlkGAEgASgFUgJpZBIUCgV0aXRsZRgCIAEoCVIFdGl0bGUSIAoLaXNDb21wbGV0ZWQYAyABKAhSC2lzQ29tcGxldGVk');
