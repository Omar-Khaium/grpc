...
class TodoServiceClient extends $grpc.Client {
  ...
  static final _$steamTodo = $grpc.ClientMethod<$0.GetTodoByIdRequest, $0.Todo>(
      '/TodoService/steamTodo',
      ($0.GetTodoByIdRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Todo.fromBuffer(value));
  ...
  $grpc.ResponseStream<$0.Todo> steamTodo($0.GetTodoByIdRequest request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$steamTodo, $async.Stream.fromIterable([request]),
        options: options);
  }
}
...
abstract class TodoServiceBase extends $grpc.Service {
  ...
  $async.Stream<$0.Todo> steamTodo_Pre($grpc.ServiceCall call,
      $async.Future<$0.GetTodoByIdRequest> request) async* {
    yield* steamTodo(call, await request);
  }

  $async.Future<$0.Todo> getTodo(
      $grpc.ServiceCall call, $0.GetTodoByIdRequest request);
  $async.Stream<$0.Todo> steamTodo(
      $grpc.ServiceCall call, $0.GetTodoByIdRequest request);
}
